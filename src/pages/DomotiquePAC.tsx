    ...
    <>
      ...
      <section ref={heroRef} className="relative h-[100svh] sm:h-[70vh] w-full overflow-hidden grain" aria-label="Domotique et pompes à chaleur partout en France">
        <motion.div className="absolute inset-0 w-full h-full" style={{ y: imageY, scale }}>
          <img src={heroImage} alt="Maison moderne avec domotique énergétique et panneaux solaires en France" className="w-full h-full object-cover" loading="eager" fetchPriority="high" decoding="async" width={1920} height={1080} />
        </motion.div>
      ...
      <section className="section-padding section-alt-deep relative grain" aria-label="Solutions domotique et pompes à chaleur">
        ...
        <div className="mx-auto max-w-6xl relative z-10">
          <BlurFade>
            ...
            <TextReveal text="Pompe à chaleur & pilotage intelligent." className="mb-4 text-3xl font-bold md:text-5xl font-heading" />
      ...
      <section className="section-padding" aria-label="Certifications et appel à l'action">
        <div className="mx-auto max-w-4xl text-center">
          <BlurFade>
            ...
            <TextReveal text="On étudie votre projet ?" className="text-3xl font-bold md:text-5xl mb-6 font-heading" />
